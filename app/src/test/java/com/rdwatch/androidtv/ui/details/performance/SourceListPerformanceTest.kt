...
class SourceListPerformanceTest {
    ...
    @Test
    fun `filter performance with 100 sources`() =
        runTest {
    ...
    @Test
    fun `filter performance with 1000 sources`() =
        runTest {
    ...
    @Test
    fun `sort performance with 100 sources`() =
        runTest {
            val sources = generateTestSources(100)
    ...
    @Test
    fun `sort performance with 1000 sources`() =
        runTest {
            val sources = generateTestSources(1000)
    ...
    @Test
    fun `quality score calculation performance with 1000 sources`() =
        runTest {
            val sources = generateTestSources(1000)
    ...
    @Test
    fun `health monitor performance with 1000 sources`() =
        runTest {
            val sources = generateTestSources(1000)
    ...
    @Test
    fun `memory usage with 1000 sources`() =
        runTest {
    ...
    @Test
    fun `complex filter and sort pipeline performance`() =
        runTest {
            val sources = generateTestSources(1000)
            val filter = createComplexFilter()
    ...
    @Test
    fun `season pack detection performance`() =
        runTest {
    ...
    @Test
    fun `concurrent filtering performance`() =
        runTest {
            val sources = generateTestSources(1000)
            val filters =
                listOf(
    ...
    @Test
    fun `sorting stability with large dataset`() =
        runTest {
            val sources = generateTestSources(1000)
    ...
    @Test
    fun `batch processing performance`() =
        runTest {
            val batchSize = 100
