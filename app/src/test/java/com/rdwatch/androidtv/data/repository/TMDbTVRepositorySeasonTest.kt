...
class TMDbTVRepositorySeasonTest {
    ...
    @Test
    fun `getSeasonDetails - cache hit with valid data returns cached season`() =
        runTest {
    ...
    @Test
    fun `getSeasonDetails - cache miss triggers API call and saves result`() =
        runTest {
    ...
    @Test
    fun `getSeasonDetails - invalid cached data triggers refresh`() =
        runTest {
    ...
    @Test
    fun `getSeasonDetails - stale cached data triggers refresh`() =
        runTest {
    ...
    @Test
    fun `getSeasonDetails - force refresh bypasses cache`() =
        runTest {
    ...
    @Test
    fun `getSeasonDetails - API error returns cached data when available`() =
        runTest {
    ...
    @Test
    fun `updateSeasonInDatabase - updates existing season correctly`() =
        runTest {
    ...
    @Test
    fun `cache invalidation - validateAndInvalidateAllSeasons clears invalid seasons`() =
        runTest {
