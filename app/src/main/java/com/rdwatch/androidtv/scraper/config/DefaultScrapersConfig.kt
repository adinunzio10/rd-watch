 ...
 */
@Singleton
class DefaultScrapersConfig @Inject constructor() {
    ...
    private fun createTorrentioManifest(): ScraperManifest {
        ...
        val stremioManifest = StremioManifest(
            ...
            behaviorHints = com.rdwatch.androidtv.scraper.models.StremioManifestBehaviorHints(
                p2p = true,
                configurable = true
            )
        )
    ...
    fun getConfigurationTemplates(): Map<String, ManifestConfiguration> {
        return mapOf(
            "torrent_stream" to ManifestConfiguration(
                rateLimitMs = 1000,
                timeoutSeconds = 30,
                retryAttempts = 3,
                cacheTtlMinutes = 30,
            ...
            "metadata" to ManifestConfiguration(
                rateLimitMs = 500,
                timeoutSeconds = 15,
                retryAttempts = 3,
                cacheTtlMinutes = 120,
            ...
            "subtitles" to ManifestConfiguration(
                rateLimitMs = 2000,
                timeoutSeconds = 20,
                retryAttempts = 2,
                cacheTtlMinutes = 60,
            ...
            "catalog" to ManifestConfiguration(
                rateLimitMs = 1000,
                timeoutSeconds = 25,
                retryAttempts = 3,
                cacheTtlMinutes = 240,
