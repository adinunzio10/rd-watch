...
class SchemaValidator @Inject constructor() {
    ...
    private fun validateRequiredRootFields(data: Map<String, Any>, errors: MutableList<ValidationError>) {
    ...
    private fun validateFieldTypes(data: Map<String, Any>, errors: MutableList<ValidationError>) {
        // String fields
    ...
    private fun validateArrayStructures(data: Map<String, Any>, errors: MutableList<ValidationError>) {
    ...
    private fun validateCatalogStructure(catalog: Map<*, *>, fieldPath: String, errors: MutableList<ValidationError>) {
    ...
    private fun validateResourceStructure(resource: Map<*, *>, fieldPath: String, errors: MutableList<ValidationError>) {
