...
class SmartCacheManager(
     ...
     */
    private suspend fun shouldCache(
        key: String,
        manifest: ScraperManifest,
    ): Boolean {
        return when (config.strategy) {
    ...
    private suspend fun putIfPopular(
        key: String,
        manifest: ScraperManifest,
    ): ManifestResult<Unit> {
    ...
    private suspend fun putIfHighPriority(
        key: String,
        manifest: ScraperManifest,
    ): ManifestResult<Unit> {
    ...
    private fun calculateAdaptiveTtl(
        key: String,
        manifest: ScraperManifest,
    ): Long {
     ...
     */
    fun getCacheRecommendation(
        key: String,
        manifest: ScraperManifest,
    ): CacheRecommendation {
        val shouldCacheResult =
