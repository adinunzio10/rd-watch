...
class FormatDetector @Inject constructor() {
     ...
     */
    fun detectWithConfidence(content: String, url: String? = null): FormatDetectionResult {
     ...
     */
    fun detectFormat(content: String, url: String? = null): ManifestFormat {
        return detectWithConfidence(content, url).format
    }
    
    private fun analyzeJsonContent(content: String, scores: MutableMap<ManifestFormat, Double>) {
        var score = 0.0
    ...
    private fun analyzeYamlContent(content: String, scores: MutableMap<ManifestFormat, Double>) {
        var score = 0.0
    ...
    private fun analyzeXmlContent(content: String, scores: MutableMap<ManifestFormat, Double>) {
        var score = 0.0
    ...
    private fun analyzeContentStructure(content: String, scores: MutableMap<ManifestFormat, Double>) {
    ...
    private fun generateReasoning(content: String, scores: Map<ManifestFormat, Double>): List<String> {
