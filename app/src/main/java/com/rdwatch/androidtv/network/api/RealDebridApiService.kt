...
interface RealDebridApiService {
    ...
    suspend fun getStreamingTranscode(@Path("id") id: String): Response<Map<String, Any>>
    
    @GET("streaming/mediaInfos/{id}")
    suspend fun getMediaInfo(@Path("id") id: String): Response<Map<String, Any>>
    ...
    suspend fun getTorrentInfo(@Path("id") id: String): Response<TorrentInfo>
    
    @GET("torrents/instantAvailability/{hash}")
    suspend fun checkInstantAvailability(@Path("hash") hash: String): Response<Map<String, Any>>
    ...
    suspend fun addTorrent(@Body file: okhttp3.RequestBody): Response<AddTorrentResponse>
    ...
    @FormUrlEncoded
    suspend fun changePassword(@Field("password") password: String): Response<Unit>
    
    @POST("settings/avatarFile")
    suspend fun uploadAvatar(@Body file: okhttp3.RequestBody): Response<Unit>
