...
class HomeViewModel @Inject constructor(
     ...
     */
    private fun filterContent(content: List<ContentDetail>, filter: ContentFilter): List<ContentDetail> {
        return when (filter) {
    ...
    private suspend fun organizeContent(content: List<ContentDetail>): HomeContent {
        ...
        val continueWatchingContent = try {
     ...
     */
    private fun organizeByContentType(movies: List<ContentDetail>, tvShows: List<ContentDetail>): Map<String, List<ContentDetail>> {
        ...
        val genreMap = allContent.groupBy { content ->
