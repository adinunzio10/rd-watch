...
data class SourceSortingConfiguration(
    ...
    private fun createCriteriaComparator(criteria: SortCriteria): Comparator<SourceMetadata> {
        return when (criteria) {
            SortCriteria.SMART -> SourceComparators.createWeightedComparator(
                qualityWeight, healthWeight, sizeWeight, providerWeight
            )
    ...
    companion object {
         ...
         */
        fun qualityFocused() = SourceSortingConfiguration(
         ...
         */
        fun androidTVOptimized() = SourceSortingConfiguration(
         ...
         */
        fun bandwidthConstrained() = SourceSortingConfiguration(
         ...
         */
        fun p2pOptimized() = SourceSortingConfiguration(
         ...
         */
        fun instantPlayback() = SourceSortingConfiguration(
...
enum class SortingPreset(val displayName: String, val description: String) {
    ...
    fun getConfiguration(): SourceSortingConfiguration {
        return when (this) {
            ...
            NEWEST_FIRST -> SourceSortingConfiguration(
