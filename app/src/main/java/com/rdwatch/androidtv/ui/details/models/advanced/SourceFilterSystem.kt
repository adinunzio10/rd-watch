...
class SourceFilterSystem {
     ...
     */
    private fun applyQualityFilters(source: SourceMetadata, filters: QualityFilters): Boolean {
        // Minimum resolution
     ...
     */
    private fun applySourceTypeFilters(source: SourceMetadata, filters: SourceTypeFilters): Boolean {
     ...
     */
    private fun applyHealthFilters(source: SourceMetadata, filters: HealthFilters): Boolean {
        // Minimum seeders
     ...
     */
    private fun applyFileSizeFilters(source: SourceMetadata, filters: FileSizeFilters): Boolean {
     ...
     * Apply codec filters
     */
    private fun applyCodecFilters(source: SourceMetadata, filters: CodecFilters): Boolean {
        // Allowed codecs
     ...
     * Apply audio filters
     */
    private fun applyAudioFilters(source: SourceMetadata, filters: AudioFilters): Boolean {
     ...
     */
    private fun applyReleaseTypeFilters(source: SourceMetadata, filters: ReleaseTypeFilters): Boolean {
     ...
     */
    private fun applyProviderFilters(source: SourceMetadata, filters: ProviderFilters): Boolean {
        // Allowed providers
     ...
     */
    private fun applyAgeFilters(source: SourceMetadata, filters: AgeFilters): Boolean {
     ...
     */
    private fun applyCustomFilters(source: SourceMetadata, filters: List<CustomFilter>): Boolean {
            ...
            when (strategy) {
                ConflictResolutionStrategy.RELAX_QUALITY -> {
                    val relaxedFilter = filter.copy(
                        qualityFilters = filter.qualityFilters.copy(
                            minResolution = filter.qualityFilters.minResolution?.let { 
                ...
                ConflictResolutionStrategy.RELAX_SIZE -> {
                    val relaxedFilter = filter.copy(
                        fileSizeFilters = filter.fileSizeFilters.copy(
