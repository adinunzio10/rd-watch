...
object BadgeStyles {
     ...
     */
    fun getColorForBadge(type: String, content: String): Color {
        return when (type.uppercase()) {
            "RESOLUTION" -> when (content) {
