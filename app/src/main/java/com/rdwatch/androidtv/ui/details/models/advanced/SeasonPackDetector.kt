...
class SeasonPackDetector {
    ...
    companion object {
        ...
        private val episodeRangePatterns = listOf(
        ...
        private val multiSeasonPatterns = listOf(
        ...
        private val completeSeasonIndicators = listOf(
            "complete", "full", "entire", "whole", "all episodes",
            "season pack", "complete season", "full season"
        )
        
        // Individual episode patterns
        private val singleEpisodePatterns = listOf(
        ...
        private val qualityPackIndicators = listOf(
            "remux pack", "bluray pack", "web-dl pack", "collection"
        )
    }
     ...
     */
    fun analyzeSeasonPack(filename: String, fileSize: Long? = null): SeasonPackInfo {
        ...
        if (seasonInfo != null) {
            ...
            val estimatedEpisodes = episodeInfo?.let { it.end - it.start + 1 } 
     ...
     */
    private fun calculateSeasonCompleteness(episodeRange: EpisodeRange?, seasonNumber: Int): Float {
     ...
     */
    private fun calculateMultiSeasonCompleteness(filename: String, seasonRange: Pair<Int, Int>): Float {
    ...
    fun getSeasonPackQualityScore(seasonPackInfo: SeasonPackInfo): Int {
        ...
        // Pack type bonus
        score += when (seasonPackInfo.packType) {
