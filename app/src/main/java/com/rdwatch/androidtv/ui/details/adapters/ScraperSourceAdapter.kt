...
class ScraperSourceAdapter
    ...
    constructor() {
        ...
        fun createStreamingSource(
            ...
            println(
                "DEBUG [ScraperSourceAdapter]: Source availability calculation: manifest.isEnabled=${manifest.isEnabled}, provider.isAvailable=${provider.isAvailable}, result=$sourceIsAvailable",
            )
            ...
            println(
                "DEBUG [ScraperSourceAdapter]: Created streaming source - ID: $sourceId, Provider: ${provider.displayName}, Quality: ${quality.displayName}, URL: $url, Available: $sourceIsAvailable",
            )
        ...
        private fun determineSourceType(
            ...
            val reliability =
                when (manifest.metadata.validationStatus.name) {
