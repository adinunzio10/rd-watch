...
class SearchResultAggregator
    ...
    constructor() {
        ...
        fun aggregateResults(
            ...
            val finalResults =
                scoredResults
                    ...
                    .sortedWith(
                        compareByDescending<AggregatedSearchResultItem> { it.aggregationScore }
        ...
        private fun calculateSimilarity(
            ...
            val yearSimilarity =
                if (result1.year != null && result2.year != null) {
 ...
 */
fun Flow<List<SearchResultItem>>.aggregateResults(config: AggregationConfig = AggregationConfig()): Flow<AggregatedSearchResults> {
    return map { results ->
