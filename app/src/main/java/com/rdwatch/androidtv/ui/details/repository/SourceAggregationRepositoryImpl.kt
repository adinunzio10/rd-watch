 ...
 */
@Singleton
class SourceAggregationRepositoryImpl
    @Inject
    constructor() : SourceAggregationRepository {
        ...
        override fun getCachedSources(contentDetail: ContentDetail): Flow<List<SourceMetadata>> =
            flow {
                val allSources =
                    getSources(contentDetail).collect { sources ->
