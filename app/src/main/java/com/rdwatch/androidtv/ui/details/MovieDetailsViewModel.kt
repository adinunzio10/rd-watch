...
class MovieDetailsViewModel
    ...
    constructor(
                    ...
                    .collect { result ->
                        when (result) {
                            is Result.Success -> {
                                ...
                                val relatedMovies =
                                    recommendationsResponse.results.take(6).map { tmdbMovie ->
                                        Movie(
        ...
        fun loadSourcesForMovie(
            ...
            viewModelScope.launch {
                ...
                try {
                    ...
                    val sources =
                        scraperSourceManager.getSourcesForContent(
                            contentId = tmdbId,
                            contentType = "movie",
                            imdbId = imdbId,
                            tmdbId = tmdbId,
                    ...
                    sources.forEach { source ->
                        println(
                            "DEBUG [MovieDetailsViewModel]: Source: ${source.provider.displayName} - ${source.quality.displayName} - ${source.url}",
                        )
                    }
         ...
         */
        private fun loadAdvancedSourcesForMovie(
        ...
        fun selectAdvancedSources() {
            ...
            sources.forEach { source ->
                println(
                    "DEBUG [MovieDetailsViewModel]: Advanced Source: ${source.provider.displayName} - ${source.quality.resolution.shortName}",
                )
            }
