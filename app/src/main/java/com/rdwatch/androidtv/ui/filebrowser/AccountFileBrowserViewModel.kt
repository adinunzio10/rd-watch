 ...
 */
@HiltViewModel
class AccountFileBrowserViewModel
    @Inject
    constructor(
        ...
        fun playSelectedFiles() {
            ...
            val playableFile =
                selectedItems.firstOrNull { item ->
                    when (item) {
        ...
        fun deleteSelectedFiles() {
            ...
            launchSafely {
                _events.emit(
                    FileBrowserEvent.ShowConfirmDialog(
                        title = "Delete Files",
        ...
        fun loadMoreContent() {
            ...
            launchSafely {
                val nextPageContent =
                    _rawContent.value.drop(currentState.paginationState.offset)
