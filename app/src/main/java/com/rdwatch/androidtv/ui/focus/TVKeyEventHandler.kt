...
class TVFocusCoordinator {
    ...
    fun updateNeighbors(id: String, neighbors: Map<NavigationDirection, String>) {
...
class TVGridFocusManager(
    ...
    fun getFocusRequester(row: Int, column: Int): FocusRequester? {
    ...
    fun focusPosition(row: Int, column: Int): Boolean {
...
@Composable
fun rememberTVGridFocusManager(columns: Int, rows: Int): TVGridFocusManager {
