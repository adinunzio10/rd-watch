...
data class SourceMetadata(
    ...
    fun getQualityScore(healthData: HealthData? = null, seasonPackInfo: SeasonPackInfo? = null): Int {
        ...
        healthData?.let { health ->
            ...
            if (health.predictedReliability >= 90) score += 25
            else if (health.predictedReliability >= 75) score += 15
            else if (health.predictedReliability >= 60) score += 10
            ...
            // Freshness bonus
            if (health.freshnessIndicator >= 90) score += 10
            else if (health.freshnessIndicator >= 70) score += 5
