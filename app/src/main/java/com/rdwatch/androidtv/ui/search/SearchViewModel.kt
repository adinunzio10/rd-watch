...
class SearchViewModel
    ...
    constructor(
        ...
        private fun ContentDetail.toSearchResultItem(): SearchResultItem {
            ...
            android.util.Log.d(
                "SearchViewModel",
                "Converting ContentDetail to SearchResultItem: ${this.contentType} id='$contentId' title='${this.title}'",
            )
        ...
        private fun updateVoiceSearchAvailability() {
            val isAvailable =
                voiceSearchManager.isVoiceSearchAvailable() &&
