...
interface FileBrowserRepository {
     ...
     */
    suspend fun getPlaybackUrl(fileId: String, torrentId: String? = null): Result<String>
     ...
     * @return Flow of Result containing filtered FileItems
     */
    fun getContentByDateRange(startDate: Long, endDate: Long): Flow<Result<List<FileItem>>>
     ...
     * @return Flow of Result containing filtered FileItems
     */
    fun getContentBySizeRange(minSize: Long, maxSize: Long): Flow<Result<List<FileItem>>>
