 ...
 */
@Singleton
class FileBrowserBackendService @Inject constructor(
     ...
     */
    suspend fun performPullToRefresh(
    ...
    suspend fun retryFailedItems(
        ...
        try {
            ...
            Result.Success(BulkOperationResult(
     ...
     */
    suspend fun getCacheInformation(): Result<CacheInformation> = withContext(dispatcherProvider.io) {
        try {
     ...
     */
    suspend fun clearAllCaches(): Result<Unit> = withContext(dispatcherProvider.io) {
        try {
     ...
     */
    suspend fun getOperationHealth(): Result<OperationHealth> = withContext(dispatcherProvider.io) {
        try {
