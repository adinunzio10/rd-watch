...
class AssParser
    ...
    constructor() : SubtitleParser {
        ...
        override fun supportsFormat(format: SubtitleFormat): Boolean = format == SubtitleFormat.ASS || format == SubtitleFormat.SSA
