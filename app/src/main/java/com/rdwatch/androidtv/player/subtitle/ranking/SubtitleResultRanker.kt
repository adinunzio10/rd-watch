 ...
 */
@Singleton
class SubtitleResultRanker @Inject constructor() {
    ...
    companion object {
        ...
        private val PROVIDER_RELIABILITY = mapOf(
        ...
        private val QUALITY_RELEASE_GROUPS = setOf(
    ...
    private fun calculateOverallScore(
        ...
        return (matchAccuracy * MATCH_ACCURACY_WEIGHT +
                ...
                technicalFactors * TECHNICAL_FACTORS_WEIGHT).coerceIn(0f, 1f)
    }
