...
class SubtitleCache @Inject constructor(
     ...
     */
    suspend fun getCachedResults(request: SubtitleSearchRequest): List<SubtitleSearchResult> = withContext(Dispatchers.IO) {
    ...
    suspend fun cacheResults(
        ...
        // Create cache entry
        val cacheEntity = SubtitleCacheEntity(
            searchKey = searchKey,
     ...
     */
    suspend fun getCachedFile(result: SubtitleSearchResult): String? = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun cacheFile(result: SubtitleSearchResult, originalFilePath: String): String = withContext(Dispatchers.IO) {
        ...
        val fileEntity = SubtitleFileEntity(
     ...
     */
    suspend fun getAllCachedFiles(contentId: String): List<SubtitleFileInfo> = withContext(Dispatchers.IO) {
    ...
    private fun generateCachedFileName(contentId: String, language: String, extension: String): String {
