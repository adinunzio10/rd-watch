...
data class SubtitleStyleConfig(
     ...
     */
    fun forScreenSize(screenWidthDp: Int, screenHeightDp: Int): SubtitleStyleConfig {
    ...
    companion object {
        ...
        fun getPresets(): Map<String, SubtitleStyleConfig> {
            return mapOf(
                ...
                "large_text" to SubtitleStyleConfig(
                    textSize = 0.12f,
                    fontWeight = FontWeight.BOLD
                ),
                "high_contrast" to SubtitleStyleConfig(
                ...
                "minimal" to SubtitleStyleConfig(
                    backgroundColor = Color.TRANSPARENT,
                    windowColor = Color.TRANSPARENT,
                    edgeType = CaptionStyleCompat.EDGE_TYPE_NONE,
                    shadowEnabled = false
                ),
                "cinema" to SubtitleStyleConfig(
                ...
                "accessibility" to SubtitleStyleConfig(
                    textSize = 0.15f,
                    textColor = Color.WHITE,
                    backgroundColor = Color.BLACK,
...
class SubtitleStyleRepository @Inject constructor(
     ...
     */
    val styleConfig: Flow<SubtitleStyleConfig> = dataStore.data.map { preferences ->
        SubtitleStyleConfig(
