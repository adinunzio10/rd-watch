...
class PlaybackProgressRepository @Inject constructor(
    ...
    suspend fun getPlaybackProgress(userId: Long, contentId: String): WatchProgressEntity? {
        return watchProgressDao.getWatchProgress(userId, contentId)
    }
    
    fun getPlaybackProgressFlow(userId: Long, contentId: String): Flow<WatchProgressEntity?> {
    ...
    suspend fun removeProgress(userId: Long, contentId: String) {
