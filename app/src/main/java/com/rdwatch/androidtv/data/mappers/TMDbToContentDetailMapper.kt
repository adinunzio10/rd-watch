 ...
 */
@Singleton
class TMDbToContentDetailMapper
    @Inject
    constructor() {
        /**
            ...
            return when (multiSearchResult.mediaType) {
                "movie" -> {
                    ...
                    TMDbMovieContentDetail(
                        ...
                        backgroundImageUrl =
                            multiSearchResult.backdropPath?.let {
                                "${TMDbMovieService.IMAGE_BASE_URL}${TMDbMovieService.BACKDROP_SIZE}$it"
                            },
                        cardImageUrl =
         ...
         * @return ContentDetail for UI consumption
         */
        fun mapSearchResultToContentDetail(
            searchResult: com.rdwatch.androidtv.network.models.tmdb.TMDbSearchResultResponse,
            ...
            android.util.Log.d(
                "TMDbMapper",
                "Mapping search result: id=${searchResult.id}, isMovie=$isMovie, isTV=$isTV, title=${searchResult.title ?: searchResult.name}",
            )
         ...
         */
        fun mapSearchResultsToContentDetails(
            searchResults: List<com.rdwatch.androidtv.network.models.tmdb.TMDbSearchResultResponse>,
            mediaType: String? = null,
        ): List<ContentDetail> {
         ...
         */
        fun mapMultiSearchResultsToContentDetails(
            multiSearchResults: List<com.rdwatch.androidtv.network.models.tmdb.TMDbMultiSearchResultResponse>,
        ): List<ContentDetail> {
