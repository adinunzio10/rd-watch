...
class SettingsRepository
    ...
    constructor(
        ...
        val videoQuality: Flow<VideoQualityPreference> =
            dataStore.data
        ...
        val playbackSpeed: Flow<PlaybackSpeedPreference> =
            dataStore.data
                .catch { emit(emptyPreferences()) }
                .map { preferences ->
        ...
        val contentLayout: Flow<ContentLayout> =
            dataStore.data
                .catch { emit(emptyPreferences()) }
                .map { preferences ->
        ...
        val showQualityBadges: Flow<Boolean> =
            getPreferenceFlow(
        ...
        val bandwidthLimit: Flow<BandwidthLimit> =
            dataStore.data
                .catch { emit(emptyPreferences()) }
                .map { preferences ->
        ...
        val showPremiumDays: Flow<Boolean> =
            getPreferenceFlow(
