...
interface FileHashDao {
    ...
    @Query("""
        ...
        LIMIT 1
    """)
    suspend fun getCachedHash(filePath: String, fileSize: Long, lastModified: Long): FileHashEntity?
    ...
    @Query("""
        ...
        AND last_modified = :lastModified
    """)
    suspend fun hashExists(filePath: String, fileSize: Long, lastModified: Long): Boolean
}