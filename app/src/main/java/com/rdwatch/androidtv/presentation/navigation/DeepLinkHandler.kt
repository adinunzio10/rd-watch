...
class DeepLinkHandler {
     ...
     */
    private fun handleMovieDetailsDeepLink(uri: Uri, pathSegments: List<String>, navController: NavController): Boolean {
    ...
    private fun handleTVDetailsDeepLink(uri: Uri, pathSegments: List<String>, navController: NavController): Boolean {
    ...
    private fun handleVideoPlayerDeepLink(uri: Uri, pathSegments: List<String>, navController: NavController): Boolean {
    ...
    private fun handleSearchDeepLink(uri: Uri, navController: NavController): Boolean {
    ...
    private fun handleBrowseDeepLink(uri: Uri, navController: NavController): Boolean {
        navController.navigateToBrowse()
        return true
    }
    
    private fun handleSettingsDeepLink(uri: Uri, navController: NavController): Boolean {
    ...
    private fun handleScraperSettingsDeepLink(uri: Uri, navController: NavController): Boolean {
        navController.navigateToScraperSettings()
        return true
    }
    
    private fun handleProfileDeepLink(uri: Uri, navController: NavController): Boolean {
        navController.navigateToProfile()
        return true
    }
    
    private fun handleAuthDeepLink(uri: Uri, navController: NavController): Boolean {
        val clearBackStack = uri.getBooleanQueryParameter("clearBackStack", true)
        navController.navigateToAuthentication(clearBackStack)
        return true
    }
    
    private fun handleErrorDeepLink(uri: Uri, navController: NavController): Boolean {
    ...
    private fun handleAccountFileBrowserDeepLink(uri: Uri, pathSegments: List<String>, navController: NavController): Boolean {
    ...
    private fun validatePathSegments(pathSegments: List<String>, uri: Uri): DeepLinkValidationResult {
        return when (val firstSegment = pathSegments[0]) {
            "movie" -> {
                val movieId = pathSegments.getOrNull(1)
                when {
